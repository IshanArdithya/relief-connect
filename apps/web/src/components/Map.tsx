          ...
          >
            <Popup>
              <div className={styles.popup}>
                ...
                <p><strong>Area:</strong> {request.approxArea}</p>
                <p><strong>Note:</strong> {request.shortNote}</p>
          ...
          >
            <Popup>
              <div className={styles.popup}>
                ...
                <p><strong>People:</strong> {camp.peopleRange}</p>
                <p><strong>Needs:</strong> {camp.needs.join(', ')}</p>
                <p><strong>Note:</strong> {camp.shortNote}</p>
